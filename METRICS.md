...
Purpose
-------
Lets the caller (monitoring application / tester / developer) retrieve metrics which describe the state of the application at a specific point in time. (For example, the number of users currently logged in to a web application)
